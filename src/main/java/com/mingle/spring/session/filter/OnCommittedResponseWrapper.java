...
/**
 * Base class for response wrappers which encapsulate the logic for handling an event when the {@link javax.servlet.http.HttpServletResponse} is committed.
 *
 * @author Rob Winch
 * @since 1.0
 */
abstract class OnCommittedResponseWrapper extends HttpServletResponseWrapper {
    ...
    /**
     * The Content-Length response header. If this is greater than 0, then once {@link #contentWritten} is larger than or equal the response is considered committed.
     */
    ...
    /**
     * Invoke this method to disable invoking {@link OnCommittedResponseWrapper#onResponseCommitted()} when the {@link javax.servlet.http.HttpServletResponse} is committed. This can be useful in the
    ...
    /**
     * Makes sure {@link OnCommittedResponseWrapper#onResponseCommitted()} is invoked before calling the superclass <code>sendError()</code>.
     *
    ...
    /**
     * Makes sure {@link OnCommittedResponseWrapper#onResponseCommitted()} is invoked before calling the superclass <code>sendRedirect()</code>.
     *
    ...
    /**
     * Makes sure {@link OnCommittedResponseWrapper#onResponseCommitted()} is invoked before calling the calling <code>getOutputStream().close()</code> or
    ...
    /**
     * Makes sure {@link OnCommittedResponseWrapper#onResponseCommitted()} is invoked before calling the <code>getWriter().close()</code> or
    ...
    /**
     * Makes sure {@link OnCommittedResponseWrapper#onResponseCommitted()} is invoked before calling the superclass <code>flushBuffer()</code>.
     *
     * @throws IOException if an input or output exception occurred
     */
    @Override
    ...
    /**
     * Ensures {@link OnCommittedResponseWrapper#onResponseCommitted()} is invoked before calling the prior to methods that commit the response. We delegate all methods to the original {@link
     * java.io.PrintWriter} to ensure that the behavior is as close to the original {@link java.io.PrintWriter} as possible. See SEC-2039
     *
     * @author Rob Winch
     */
    ...
    /**
     * Ensures{@link OnCommittedResponseWrapper#onResponseCommitted()} is invoked before calling methods that commit the response. We delegate all methods to the original {@link
     * javax.servlet.ServletOutputStream} to ensure that the behavior is as close to the original {@link javax.servlet.ServletOutputStream} as possible. See SEC-2039
     *
     * @author Rob Winch
     */
