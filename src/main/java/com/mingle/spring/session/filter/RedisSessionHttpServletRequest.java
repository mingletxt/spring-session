...
/**
 * Created by mingle. Time 2019-06-04 19:47 Desc 文件描述
 */
public class RedisSessionHttpServletRequest implements HttpServletRequest {
    
    private static String CURRENT_SESSION_ATTR = "CURRENT_SESSION";
    ...
    public HttpSession getSession(boolean create) {
        ...
        httpSession = getRequestedSession();
        return
    }
